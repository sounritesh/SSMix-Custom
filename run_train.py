...
def parse_argument():
    ...
    parser.add_argument('--pretrained_model', type=str, default='bert-base-multilingual-uncased', help='pretrained model')
    ...
    parser.add_argument('--dataset', type=str, default='xnli', help='Dataset to use')
    ...
    args.nli_dataset = args.dataset in ['mnli', 'mrpc', 'qqp', 'qnli', 'rte', 'anli', 'xnli']
